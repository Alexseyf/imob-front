        ...
        {menuOpen && (
          <div className="fixed inset-0 z-50 md:hidden" onClick={() => setMenuOpen(false)}>
            ...
            >
              ...
              <button onClick={handleHomeClick} className="flex items-center gap-2 text-lg font-medium text-orange-600 hover:text-orange-800">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" /></svg>
                Home
              </button>
              {isMounted && isAuthenticated && userType === "CLIENTE" && (
                <Link href="/agendamentos" className="flex items-center gap-2 text-lg font-medium text-gray-700 hover:text-orange-600">
              ...
              {isMounted && isAuthenticated && (userType === "ADMIN" || userType === "SUPORTE") && (
                <Link href="/dashboard" className="flex items-center gap-2 text-lg font-medium text-gray-700 hover:text-orange-600">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" /></svg>
                  Dashboard
                </Link>
              )}
              {isMounted && isAuthenticated ? (
                <button onClick={handleLogout} className="flex items-center gap-2 text-lg font-medium text-red-600 hover:text-red-800">
                ...
                <Link href="/login" className="flex items-center gap-2 text-lg font-medium text-orange-600 hover:text-orange-800">
