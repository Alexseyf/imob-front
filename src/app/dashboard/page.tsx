      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-gray-600 mt-2 text-center">Gerenciar imóveis cadastrados</p>
          </button>
          ...
          >
            ...
            <p className="text-gray-600 mt-2 text-center">Gerenciar clientes cadastrados</p>
          </button>
          ...
          >
            ...
            <p className="text-gray-600 mt-2 text-center">Gerenciar agendamentos de visitas</p>
          </button>
        </div>
      </div>
    </div>
